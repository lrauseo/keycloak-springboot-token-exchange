...
public class ExampleController {
    ...
    public Map<String, Object> serviceInfo() {
        ...
        @Operation(
                        summary = "Chained service call (full round-trip)",
                        description = "example-service calls example-service2 propagating the same JWT. " +
                                                  "Response shows the token as seen at each hop.",
        ...
        public Map<String, Object> chained(
                ...
                // Step 1 — build the outgoing request with the SAME JWT (no new exchange needed)
    ...
    @Operation(
            ...
            description = "Requires a valid JWT from example-service-realm OR gateway-realm",
            security = @SecurityRequirement(name = "BearerAuth")
    )
    ...
    @Operation(
            ...
            description = "Returns decoded JWT claims — useful to see which realm issued the token",
            security = @SecurityRequirement(name = "BearerAuth")
    )
